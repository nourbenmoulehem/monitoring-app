...
import { useGetMonthlyChequierCountsQuery } from 'state/api';
import { useTheme } from "@mui/material";

const MonthlyChequierCounts = () => {
  const isDashboard = true;
  console.log("AY AASLEMA O MAR7BEEE BIIIIIIIIIIIIIIIIIIIIIK!!!!");
  const theme = useTheme();
  const { data, isLoading } = useGetMonthlyChequierCountsQuery();
...
export default MonthlyChequierCounts