...
import { useGetVirementCountByEtatQuery } from "state/api";

const EtatVirementPie = () => {
  const theme = useTheme();
  const { data, isLoading } = useGetVirementCountByEtatQuery();
...
export default EtatVirementPie